...
$this->title = Yii::t('tracking', 'Update CPC');
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="control-label col-sm-2">CPC:</label>
                    <div class="col-sm-10">
                        <div class="input-group m-b">
                            <input name="cpc" id="cpc" type="text" class="form-control"> <span class="input-group-addon">$</span>
                        </div>
                    </div>
                </div>
            </div>
