 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'backend\modules\gii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'backend\modules\gii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'backend\modules\gii\generators\model\Generator'],
            'crud' => ['class' => 'backend\modules\gii\generators\crud\Generator'],
            'controller' => ['class' => 'backend\modules\gii\generators\controller\Generator'],
            'form' => ['class' => 'backend\modules\gii\generators\form\Generator'],
            'module' => ['class' => 'backend\modules\gii\generators\module\Generator'],
            'extension' => ['class' => 'backend\modules\gii\generators\extension\Generator'],
        ];
    }
}
