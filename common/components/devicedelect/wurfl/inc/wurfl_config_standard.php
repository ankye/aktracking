...
$wurflDir = __DIR__.'/../WURFL';
$resourcesDir = __DIR__.'/../resources';

require_once $wurflDir.'/Application.php';

$persistenceDir = Yii::getAlias("@base/web/storage/wurfl/persistence");//$resourcesDir.'/storage/persistence';
$cacheDir = Yii::getAlias("@base/web/storage/wurfl/cache"); // $resourcesDir.'/storage/cache';
